...
SECRET_KEY = 'hkbykvyc)54u=!5mzuo0bn3v%s#m9+3$e%otcb+ul3gjt8yh^h'
...
STATIC_URL = '/static/'  # для работы с медиафайлами которые есть в проекте (обложка, реклама, которые постоянно на сайте и не меняются
STATICFILES_DIRS = (
